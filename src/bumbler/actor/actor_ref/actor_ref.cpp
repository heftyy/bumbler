...
void actor_ref::tell_impl(std::unique_ptr<message> msg) const {
...
void actor_ref::ask_impl(std::unique_ptr<message> msg, const std::function<void(boost::any)>& response_fn) const {
