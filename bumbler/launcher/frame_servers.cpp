...
MyFrame::MyFrame(const wxString& title, const wxPoint& pos, const wxSize& size)
    ...
    servers_ = std::unique_ptr<wxListBox>(
            new wxListBox(this, LISTBOX_Servers, wxDefaultPosition, wxDefaultSize, 0, NULL,
                          wxLB_HSCROLL | wxLB_SINGLE | wxLB_NEEDED_SB));
    wxButton *addServer = new wxButton(this, BUTTON_AddServer, _T("Add Server"), wxDefaultPosition, wxDefaultSize, 0);
    wxButton *deleteServer = new wxButton(this, BUTTON_DeleteServer, _T("Delete Server"), wxDefaultPosition,
                                          wxDefaultSize, 0);
